...
const TableOfContents = [
  {
    title: "Introduction",
    link: "/docs/intro",
    description: "Get started with Aramid Finance",
  },
  {
    title: "Supported Networks and Assets",
    link: "/docs/supported-networks-and-assets",
    description: "Explore the networks and assets supported by Aramid",
  },
  {
    title: "Using Aramid Bridge",
    link: "/docs/using-aramid-bridge",
  ...
  },
  {
    ...
    link: "/docs/cross-chain-messaging",
    description: "Discover Aramid's cross-chain messaging capabilities",
  },
  {
    title: "Governance and Upgradability",
    link: "/docs/governance-and-upgradability",
    description: "Learn about Aramid's governance model and upgradability",
  },
  {
    title: "Security Features",
    link: "/docs/security-features",
    description: "Explore the security features of Aramid",
  },
  {
    title: "Fee Structure",
    link: "/docs/fee-structure",
    description: "Understand Aramid's fee structure",
  },
  {
    title: "Security Audits",
    link: "/docs/security-audits",
    description: "View Aramid's security audit reports",
  },
  {
    title: "Support",
    link: "/docs/support",
  ...
  {
    title: "Voi Metrics Report 2024-09 to 2025-05",
    link: "/docs/voi-metrics-report-2024-09-to-2025-05",
  ...
  },
  {
    ...
    description:
      "Technical guide for setting up and running Aramid Soldier nodes",
  },
];
